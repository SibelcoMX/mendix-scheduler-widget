    ...
    _createClass(ResourceView, [{
        ...
        value: function render() {
            ...
            var resourceList = displayRenderData.map(function (item) {
                ...
                var tdStyle = { height: item.rowHeight, backgroundColor: item.isUnplan ? schedulerData.config.unplannedSlotColor : '' };
                if (item.groupOnly) {
                    tdStyle = _extends({}, tdStyle, {
                        backgroundColor: item.isUnplan ? schedulerData.config.unplannedSlotColor : schedulerData.config.groupOnlySlotColor
                    });
                }
